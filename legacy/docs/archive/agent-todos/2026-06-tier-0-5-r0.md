...
> **SUPERSEDED 2026-06-20** — replaced by the new flat `TODO.md` (GPU-driven roadmap v1). This file is the verbatim historical record of the Tier 0..5 r0 plan. Closed sub-tasks summary: see `CHANGELOG.md` 2026-06 entries + `agent/active-sessions.md` commits `cf4b535`, `af69d06`, `bafecf9`, `08de29d`, `20b2d9e`, `44362d1`, `72eca66`, `f7fb8f2`, `d641967`, `6fe9201`, etc.
