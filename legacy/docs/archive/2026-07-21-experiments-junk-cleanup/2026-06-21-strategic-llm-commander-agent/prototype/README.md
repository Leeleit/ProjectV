...
- `strategic_llm_bench.cpp` (~450 LoC) — self-contained C++26 CPU-only analytical model.
    ...
    - 5 scenes (early_war_breakthrough / mid_war_2front / late_war_attrition / naval_invasion /
      defensive_counterattack).
    - 5 seeds × 10 warmup + 1000 main = 125,000 main measurements.
    - Mock-LLM cost/quality calibrated to IFPV 19.4% improvement + ReAct 34% ALFWorld + CICERO top-10% human-level +
      HoI4 production baseline.
