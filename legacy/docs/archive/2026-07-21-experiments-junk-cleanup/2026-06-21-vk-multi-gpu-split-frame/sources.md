...
### 1.1 [Khronos docs —
`VK_KHR_device_group`](https://docs.vulkan.org/refpages/latest/refpages/source/VK_KHR_device_group.html) (rev 4, ratified 2017-10-10,
...
### 1.2 [Khronos docs —
`VK_KHR_device_group_creation`](https://docs.vulkan.org/refpages/latest/refpages/source/VK_KHR_device_group_creation.html) (rev 1, ratified 2016-10-19,
**promoted to Vulkan 1.1**)
...
### 1.3 [Khronos docs —
`VkDeviceGroupPresentInfoKHR`](https://docs.vulkan.org/refpages/latest/refpages/source/VkDeviceGroupPresentInfoKHR.html) (core 1.1+)
