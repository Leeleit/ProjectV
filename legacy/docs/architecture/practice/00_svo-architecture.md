...
- [Compute Shaders](../../libraries/slang/02_integration.md)
- [VMA Integration](../../libraries/vma/02_integration.md)
- [Roadmap & Scope](../academic/roadmap_and_scope.md) — MVP vs Vision
