...
Автоматическая генерация UI и сериализация на основе типов.

---

## Обзор

ProjectV использует **C++26 P2996 Static Reflection** и библиотеку **glaze** для:
...
- [Glaze Reference](../../libraries/glaze/01_reference.md)
- [Serialization Strategy](./11_serialization.md)
- [C++ Language Standard](../../standards/cpp/00_language-standard.md)
