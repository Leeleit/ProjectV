...
> Как подключить meshoptimizer к воксельному движку на Vulkan 1.4 + Flecs ECS + VMA с интеграцией ProjectV
> MemoryManager, Logging и Profiling.
...
meshoptimizer — stateless библиотека, работающая с предоставленными буферами. ProjectV использует ArenaAllocator для
временных данных.
