...
### Фундамент (01_foundation/)

| Документ                                                               | Описание                     |
|------------------------------------------------------------------------|------------------------------|
| [Манифест](philosophy/01_foundation_new/01_manifesto.md)               | Основные принципы разработки |
| [Антипаттерны](philosophy/01_foundation_new/02_anti-patterns.md)       | Запрещённые практики         |
| [Принятие решений](philosophy/01_foundation_new/03_decision-making.md) | Процесс принятия решений     |
| [Evil Hacks](philosophy/01_foundation_new/04_evil-hacks-philosophy.md) | Обоснованные нарушения       |

### Парадигмы (02_paradigms/)

| Документ                                                                           | Описание                          |
|------------------------------------------------------------------------------------|-----------------------------------|
| [Zero-cost abstractions](philosophy/02_paradigms_new/01_zero-cost-abstractions.md) | Абстракции без накладных расходов |
| [DOD-философия](philosophy/02_paradigms_new/02_dod-philosophy.md)                  | Data-Oriented Design              |
| [ECS-философия](philosophy/02_paradigms_new/03_ecs-philosophy.md)                  | Entity Component System           |
| [Конкурентность](philosophy/02_paradigms_new/04_concurrency-philosophy.md)         | Многопоточность                   |

### Доменная специфика (03_domain/)

| Документ                                                                  | Описание                    |
|---------------------------------------------------------------------------|-----------------------------|
| [Оптимизация](philosophy/03_domain_new/01_optimization-philosophy.md)     | Принципы оптимизации        |
| [Vulkan-философия](philosophy/03_domain_new/02_vulkan-philosophy.md)      | Подход к графическому API   |
| [Воксельные данные](philosophy/03_domain_new/03_voxel-data-philosophy.md) | Организация данных вокселей |
| [Тестирование](philosophy/03_domain_new/04_testing-philosophy.md)         | Подход к тестированию       |
