...
**🟢🟡 Уровень 1-2: Базовый + Средний** — Настройка окружения, CMake, инициализация, surface, swapchain.

---

## Содержание

1. [CMake конфигурация](#cmake-конфигурация)
2. [volk: Загрузка Vulkan функций](#volk-загрузка-vulkan-функций)
3. [Инициализация Instance](#инициализация-instance)
4. [Debug Messenger](#debug-messenger)
5. [Surface через SDL3](#surface-через-sdl3)
6. [Swapchain](#swapchain)
7. [VMA: Управление памятью](#vma-управление-памятью)
