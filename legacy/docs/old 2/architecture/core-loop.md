...
- [Компоненты цикла](#компоненты-цикла)
- [Детальная реализация](#детальная-реализация)
- [Синхронизация через Timeline Semaphores](#синхронизация-через-timeline-semaphores)
...
world.system<Transform, PhysicsBody>()
    .kind(flecs::OnUpdate)
    .each([](Transform& t, PhysicsBody& pb) {
...
1. **[Resource Management](resource-management.md)** — Централизованное управление ресурсами с VMA и FastGLTF
2. **[Voxel Pipeline](voxel-pipeline.md)** — GPU-Driven рендеринг вокселей с Bindless подходами
3. **[Modern Vulkan Guide](modern-vulkan-guide.md)** — Переход на Vulkan 1.4 с Dynamic Rendering
...
🔗 **[SDL ProjectV Integration](../sdl/projectv-integration.md)** — Использование SDL в гибридном цикле
🔗 **[Vulkan ProjectV Integration](../vulkan/projectv-integration.md)** — Vulkan 1.4 для воксельного рендеринга
🔗 **[JoltPhysics ProjectV Integration](../joltphysics/projectv-integration.md)** — Физика с фиксированным шагом
🔗 **[Tracy ProjectV Integration](../tracy/projectv-integration.md)** — Профилирование гибридного цикла

### Примеры кода

🔗 **[architecture_core_loop.cpp](../../examples/architecture_core_loop.cpp)** — Полная реализация гибридного цикла
🔗 **[architecture_interpolation.cpp](../../examples/architecture_interpolation.cpp)** — Интерполяция физических
трансформов
🔗 **[architecture_timeline_sync.cpp](../../examples/architecture_timeline_sync.cpp)** — Timeline Semaphores
синхронизация
...
**Следующее обновление:** После реализации Resource Management
