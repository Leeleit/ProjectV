# Asset Management: Runtime Loading [🟡 Уровень 2]

**🟡 Уровень 2: Средний** — Загрузка и управление ассетами в runtime.
...
- [fastgltf Documentation](../../libraries/fastgltf/00_overview.md)
- [glaze Serialization](../../libraries/glaze/00_overview.md)
- [VMA Memory Management](../../libraries/vma/00_overview.md)
