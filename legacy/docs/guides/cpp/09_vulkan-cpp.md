...
> См. [06_vulkan-philosophy.md](../../philosophy/03_domain/02_vulkan-philosophy.md). RAII для GPU ресурсов — это не
> просто
> удобство,
...
**Связь с библиотеками:** Подробнее о VMA см. [../../libraries/vma/](../../libraries/vma/).
