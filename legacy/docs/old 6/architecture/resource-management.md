...
- [Решение: ResourceManager](#решение-resourcemanager)
- [Детальная реализация](#детальная-реализация)
- [Интеграция с VMA](#интеграция-с-vma)
- [Интеграция с FastGLTF](#интеграция-с-fastgltf)
- [Интеграция с Flecs ECS](#интеграция-с-flecs-ecs)
...
1. **[Voxel Pipeline](voxel-pipeline.md)** — GPU-Driven рендеринг вокселей с Bindless подходами
2. **[Modern Vulkan Guide](modern-vulkan-guide.md)** — Переход на Vulkan 1.4 с Dynamic Rendering
3. **[Core Loop](core-loop.md)** — Гибридный игровой цикл ProjectV
4. **[Flecs-Vulkan Bridge](../flecs/projectv-integration.md)** — Интеграция ECS с Vulkan ресурсами
5. **[Jolt-Vulkan Bridge](../joltphysics/projectv-integration.md)** — Синхронизация физики и рендеринга

### Связанные документы

🔗 **[VMA ProjectV Integration](../vma/projectv-integration.md)** — VMA для воксельного движка
🔗 **[FastGLTF ProjectV Integration](../fastgltf/projectv-integration.md)** — Zero-copy загрузка моделей
🔗 **[Vulkan ProjectV Integration](../vulkan/projectv-integration.md)** — Vulkan 1.4 для управления ресурсами
🔗 **[Tracy ProjectV Integration](../tracy/projectv-integration.md)** — Профилирование использования памяти

### Примеры кода

🔗 **[architecture_resource_manager.cpp](../../examples/architecture_resource_manager.cpp)** — Полная реализация
ResourceManager
🔗 **[architecture_vma_integration.cpp](../../examples/architecture_vma_integration.cpp)** — Интеграция с VMA
🔗 **[architecture_async_loading.cpp](../../examples/architecture_async_loading.cpp)** — Асинхронная загрузка ресурсов
🔗 **[architecture_hot_reload.cpp](../../examples/architecture_hot_reload.cpp)** — Hot reloading для разработки
...
→ **[Далее: Voxel Pipeline](voxel-pipeline.md)**
...
**Следующее обновление:** После реализации Voxel Pipeline
