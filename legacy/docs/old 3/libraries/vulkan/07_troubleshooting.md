...
**🟢🟡 Уровень 1-2: Базовый + Средний** — Решение типичных проблем Vulkan: validation errors, ошибки синхронизации,
проблемы с памятью.
...
3. [Проблемы синхронизации](#проблемы-синхронизации)
4. [Проблемы с памятью](#проблемы-с-памятью)
5. [Проблемы с Swapchain](#проблемы-с-swapchain)
6. [Отладка шейдеров](#отладка-шейдеров)
7. [Инструменты отладки](#инструменты-отладки)
