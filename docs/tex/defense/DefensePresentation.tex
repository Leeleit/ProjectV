  ...
  \begin{table}
    ...
    \resizebox{\textwidth}{!}{%
      \begin{tabular}{llll}
        ...
        \midrule
        \textbf{Кадочников Л. (le1t)} & T2 Demo \& Стек & Архитектура, Тимлид & AppState, ECS-мост, снапшоты, горячая перезагрузка \\
        Тиммейт 1 & T1 Проблема, Цели & Сборка, тесты & Настройка CMake presets, CTest, Runtime Smoke скрипты \\
        Тиммейт 2 & T3 Архитектура, Код & Воксельный мир & Чанки $8\times8\times8$, материалы, Fluid CA, voxel raycast \\
        Тиммейт 3 & (Q\&A сессия) & Рендеринг & CSM (тени), PCF 5$\times$5, контактные тени, TAA-сглаживание \\
        Тиммейт 4 & T6 Роадмап, Риски & Физика движка & Jolt Physics, walk-контроллер, creative/spectator режимы \\
        Тиммейт 5 & T5 Фичи, Метрики & Ассеты, звук & glTF-пайплайн, Draco, miniaudio, MP3 плейлисты \\
        \bottomrule
      \end{tabular}%
    }
  \end{table}
