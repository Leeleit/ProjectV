...
| T3   | 2:20–3:05   | Слайды 7, 8 (Voxel + Тесты)                      | Тиммейт 2      | Воксельный мир                  |
| T5   | 3:05–3:55   | Слайды 9, 10 (фичи + метрики)                    | Тиммейт 5      | Ассеты и аудио                  |
| T6   | 3:55–4:30   | Слайды 11, 12, 13 (ограничения, команда, закрытие) | Тиммейт 4 + le1t | Физика + walk + Q&A invite |
...
### Speaker notes (verbatim — Тиммейт 4 в slot T6, ~10 секунд)
...
- В текущем slot mapping Тиммейт 3 не озвучивает отдельный слайд (его slot T4 не используется в 5-мин формате, чтобы
  уложиться в 13 слайдов).
...
### Speaker notes (verbatim — le1t в slot T6, ~10 секунд)
