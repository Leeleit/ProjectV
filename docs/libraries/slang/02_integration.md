...
Способы установки Slang: Vulkan SDK, бинарные пакеты, сборка из исходников.
...
Интеграция Slang с Vulkan API: SPIR-V, bindings, push constants, buffer device address.
...
Почему Slang выбран для воксельного движка ProjectV и как он интегрируется в архитектуру.
...
Детали интеграции Slang в сборку ProjectV и реализация SlangShaderManager.
...
Специфичные паттерны шейдеров для воксельного движка ProjectV.
...
Демонстрация уникальных возможностей Slang.
