...
Введение в шейдерный язык Slang, его возможности и области применения.
...
Фундаментальные концепции языка Slang: модули, generics, интерфейсы, модель компиляции.
...
Синтаксис, атрибуты, ключевые слова и конструкции языка Slang.
...
Полный справочник команд `slangc`, Slang C API и Reflection API.
