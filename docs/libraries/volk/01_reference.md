...
// ... остальные ~250 глобальных функций Vulkan (vkEnumerateInstanceVersion, vkEnumerateInstanceExtensionProperties, etc.)
```
...
struct VolkDeviceTable {
    ...
    // ... остальные ~400 device функций Vulkan (vkCmdDraw, vkCmdBindPipeline, vkCmdDispatch, etc.)
};
```
