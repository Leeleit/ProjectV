...
- Phase 2 (web-research): DONE — War Thunder damage model + DCS + IL-2 Sturmovik + hit-table architecture literature.
...
- Complementary к `wind-simulation-ballistics` (closed mixed, fire spread direction) + `helicopter-rotor-physics` (closed yes, shared component model).
