...
- **Web search protocol:** Exa 429 + DuckDuckGo CAPTCHA + Startpage + Brave 6 calls OK then 429 + direct `webfetch` to canonical URLs (per `agent/knowledge.md Part B §9` line 1424 fallback list).
