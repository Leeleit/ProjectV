...
- 2026-06-21 — web-research via DuckDuckGo HTML + direct `webfetch` (Exa HTTP 429 persistent per the web_search fallback chain); 7 primary sources verified.
...
- All CPU prototype, no GPU dispatch. Real Vulkan compute cost expected to be 5-10× lower than CPU per `agent/knowledge.md`.
