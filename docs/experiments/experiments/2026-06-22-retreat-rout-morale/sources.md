...
Exa HTTP 429 + DuckDuckGo CAPTCHA blocked this session per the web_search fallback chain. Direct `webfetch` to canonical Wikipedia + game developer URLs confirmed content.