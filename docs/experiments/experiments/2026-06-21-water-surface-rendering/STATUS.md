...
- `2026-06-21` — Web research complete via DuckDuckGo HTML fallback (Exa `web_search` HTTP 429 persistent per `agent/knowledge.md Part B §9`). 15+ primary + secondary sources verified: Tessendorf 2001 + Johanson 2004 + Finch NVIDIA GPU Gems 2 Ch 1 + Timethy Hyman 2026 + WSCG 2025 + deiss/fftocean + Barth Paleologue 2025 + Hanno Malie 2025 + 7 supplementary.
