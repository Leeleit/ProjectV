...
- 2026-06-21 — Phase 1 web-research complete: 3 primary academic (Müller 2007 PBD, Macklin 2016 XPBD, Bouaziz 2014 PD) + 3 production OSS (Pies, XPBD-Cloth-Simulation, imstk) + 13 cross-references в ProjectV closed experiments. 7+ primary sources verified через direct webfetch + DuckDuckGo HTML (Exa HTTP 429 persistent per the web_search fallback chain).
