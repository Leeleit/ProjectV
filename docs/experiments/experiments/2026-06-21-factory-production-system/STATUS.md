...
- [x] **Phase 2 (web-research):** DONE via direct `webfetch` (Exa HTTP 429 persistent this session per the web_search fallback chain). **6 primary + 3 secondary + 13 ProjectV cross-refs verified** в [`sources.md`](./sources.md).
