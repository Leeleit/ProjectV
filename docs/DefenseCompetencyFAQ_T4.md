# Defense Competency FAQ — Тиммейт 4 (Физика и walk-контроллер)

**Участник:** [Имя Тимейта 4]
**Реальная компетенция:** Физика (Jolt, walk-контроллер, edge grace, sneak, автопрыжок, режимы)
**Speech slot на сцене:** T6 Планы и Закрытие (4:00-4:30)
**Verbatim текст выступления:** `docs/DefenseScript_Team.md` → раздел «Участник 6 (Планы и Завершение)»

**Out of scope (к кому перенаправлять в Q&A):** выбор Jolt — к le1t; стек/сборка — к Тиммейту 1; воксельный мир — к Тиммейту 2; рендеринг — к Тиммейту 3; ассеты/аудио — к Тиммейту 5; все баги — к le1t.
