...
> Чтобы прочитать книгу, ты идёшь в комнату A, берёшь книгу, идёшь в комнату B за закладкой, идёшь в комнату C за очками.
...
> снова детектив. Тебе нужны только детективы. Но кэш‑линия (64 байта) — это «захват рукой». Ты хватаешь книгу — но вместе
...
> перед ним на столе. Cold‑данные — архивы, которые нужны раз в месяц: они в шкафу в другом помещении. Если свалить всё на
> стол — клерк не сможет работать, ему придётся перерывать кучу бумаг, чтобы найти нужное. А если оставить на столе только
