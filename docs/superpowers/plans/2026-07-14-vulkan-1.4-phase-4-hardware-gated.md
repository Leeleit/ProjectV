...
>
> **Repo protocol:** Work only on `main` ([AGENTS.md](AGENTS.md) §5.4). Agent proposes commit messages; operator commits ([AGENTS.md](AGENTS.md) §5.1). Failed attempts → archive under `legacy/docs/archive/YYYY-MM-DD-<task>-attempt/` before rollback (§7.2).
...
- Commits: propose §5.1 message; operator commits on `main`.
