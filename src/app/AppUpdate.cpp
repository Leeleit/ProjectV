	...
	DebugStats &stats)
{
	if (!audio) {
		...
		stats.audioMusicTrackName.fill('\0');
		stats.audioMusicArtist.fill('\0');
		stats.audioMusicTitle.fill('\0');
