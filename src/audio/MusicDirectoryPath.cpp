...
std::filesystem::path GetMusicDirectoryPath()
{
	...
	///
	/// \details
	/// Env-var override (highest priority). The
	...
	///
	/// \details
	/// **Repo-root walk-up from the binary's
	...
	///
	/// \details
	/// CWD-relative `./music`. Works when the
	...
	///
	/// \details
	/// Last-ditch: CWD-relative `./music` even
