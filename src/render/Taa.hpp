...
/// \brief 8-tap Halton(2,3) sub-pixel jitter sequence, in *pixel* units relative to
///
/// \details
...
/// \brief Compute the (texel-size, validity) tuple stored in
///
/// \details
...
///
/// \details
/// per-layer history parameters. Same layout as
