...
constexpr float kDefaultCloudCoverage = 0.65f; // default cloud coverage (0..1); 0.65 per Nubis 2017 reference.
constexpr float kDefaultCloudContrast = 0.5f;  // default cloud layer contrast (0..1); 0.5 = balanced.
constexpr float kDefaultCloudColorR = 0.92f;   // default cloud color (linear RGB), slightly warm cumulus white per Hillaire 2020.
